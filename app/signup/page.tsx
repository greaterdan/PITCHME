...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="w-1/2 bg-gray-900 flex items-center justify-center p-8">
        <div className="max-w-md w-full">
          ...
          <div className="flex justify-center mb-8">
            <div className="w-8 h-8 bg-gradient-to-br from-pink-400 via-orange-500 to-purple-600 rounded-lg flex items-center justify-center">
          ...
          <div className="space-y-3 mb-6">
            ...
            >
              ...
              <span className="bg-blue-500 text-white text-xs px-2 py-1 rounded">Last used</span>
            </button>
          ...
          <div className="mb-6">
            ...
            <input
              type="email"
              placeholder="Email"
              className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white placeholder-gray-400 focus:outline-none focus:border-gray-600 transition-colors duration-200"
            />
          </div>
          ...
          {/* Continue Button */}
          <button className="w-full bg-white hover:bg-gray-100 text-gray-900 font-medium py-3 px-4 rounded-lg transition-colors duration-200 mb-6">
            Continue
          </button>
      ...
      {/* Right Side - Landing Page Background with Chatbox */}
      <div className="w-1/2 relative overflow-hidden">
        {/* Background gradient */}
        <div className="absolute inset-0 bg-gradient-to-b from-blue-900 via-purple-900 to-pink-500"></div>
